...
static void mavlink_test_sensor_data(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_sensor_data_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sensor_data_pack(system_id, component_id, &msg , packet1.depth , packet1.temperature , packet1.roll , packet1.yaw , packet1.pitch , packet1.roll_acc , packet1.yaw_acc , packet1.pitch_acc );
    mavlink_msg_sensor_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sensor_data_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.depth , packet1.temperature , packet1.roll , packet1.yaw , packet1.pitch , packet1.roll_acc , packet1.yaw_acc , packet1.pitch_acc );
    mavlink_msg_sensor_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_sensor_data_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sensor_data_send(MAVLINK_COMM_1 , packet1.depth , packet1.temperature , packet1.roll , packet1.yaw , packet1.pitch , packet1.roll_acc , packet1.yaw_acc , packet1.pitch_acc );
    mavlink_msg_sensor_data_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
